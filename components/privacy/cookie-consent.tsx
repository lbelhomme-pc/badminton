        ...
        <div className="flex gap-4">
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-6 text-slate-200">
              Le site utilise les éléments indispensables à son fonctionnement. Vous pouvez accepter ou refuser les futurs services facultatifs de mesure d’audience et contenus tiers.
            </p>
