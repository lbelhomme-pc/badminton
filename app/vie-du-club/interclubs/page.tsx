...
export default function InterclubsPage() {
  return (
    <InfoPage
      eyebrow="Vie du club"
      title="Interclubs"
      intro="Les interclubs permettent de représenter le CF2V41 en équipe, dans une ambiance sportive et collective. Les équipes exactes, capitaines et calendriers sont à confirmer par le club chaque saison."
      cards={[
