  ...
  return (
    <InfoPage
      ...
      cards={[
        ...
        { title: "Documents", text: "Questionnaire santé, certificat si nécessaire et autorisation parentale sont préparés avant validation.", href: "/inscription#documents" }
      ]}
    >
      <div className="rounded-lg border border-court-200 bg-white p-5 shadow-soft">
        ...
        <div className="mt-5 flex flex-col gap-3 sm:flex-row">
          {!registration.isFallback ? (
            <Link href={registration.url} target="_blank" rel="noreferrer" className="inline-flex h-12 items-center justify-center gap-2 rounded-lg bg-court-500 px-5 font-semibold text-white shadow-soft transition hover:bg-court-600">
              S'inscrire via FFBaD / Poona <ExternalLink className="h-4 w-4" aria-hidden="true" />
            </Link>
          ) : null}
          <Link
            href="/contact"
