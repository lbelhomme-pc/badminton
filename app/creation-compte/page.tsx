...
export const metadata: Metadata = {
  ...
  description: "Création d'un compte adhérent CFVV avec vérification du numéro de licence FFBaD."
};
    ...
    <main className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      <div className="mb-8 text-center">
        ...
        <p className="mx-auto mt-3 max-w-2xl text-ink-500">
          Le compte est activé avec ton numéro de licence FFBaD, puis sert à réserver un créneau, commander des volants et recevoir les informations du club.
        </p>
      </div>
      <SignupForm />
    </main>
