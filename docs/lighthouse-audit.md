...
Ce projet fournit un audit Lighthouse reproductible pour les pages publiques principales du CF2V41.
...
- Lighthouse n'est pas ajouté aux dépendances du projet pour ne pas alourdir l'installation.
