# Checklist de publication saisonnière CFVV

Cette checklist aide le bureau et les bénévoles ? vérifier le site avant chaque nouvelle saison.
...
- [ ] Vérifier le nom affich? du club : CFVV.
- [ ] Vérifier le nom complet : Club des fous du Volant Vendômois.
- [ ] Vérifier la ville affichée : Vendôme.
- [ ] Vérifier le siège social affich? : Naveil, ou complèter si le bureau décide d'afficher plus d'informations.
...
- [ ] Vérifier que le gymnase indiqu? est correct.
- [ ] Vérifier le public concern? : jeunes, adultes, loisirs, compétiteurs.
...
- [ ] Retirer les coordonnées personnelles qui ne doivent pas apparaêtre publiquement.
...
O? modifier :
- Administration du site > Paramètres, si le gymnase est centralis?.
...
- [ ] Vérifier qu'un adhérent peut commander la bonne quantit?.
...
Guide utile :
- [Recommandations photos du club](./photos-club.md)
...
- [ ] Le site peut être annonc? aux adhérents et aux nouveaux visiteurs.
